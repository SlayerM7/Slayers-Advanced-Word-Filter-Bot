...
module.exports = {
    ...
    run(client, message, args, db) {
        let ignoredRolesArr = db.get(`filter_${message.guild.id}_settings-ignore-roles`);
        let ignoredRolesStr = "";
        if (ignoredRolesArr) {
        ...
        let ignoredUsersArr = db.get(`filter_${message.guild.id}_settings-ignore-users`);
        let ignoredUsersStr = "";
        if (ignoredUsersArr) {
        ...
        let ignoredChannelsArr = db.get(`filter_${message.guild.id}_settings-ignore-users`);
